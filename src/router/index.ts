...
const routes = [
    ...
    { path: '/team-setup', name: 'Kioku Setup', component: TeamSetupPage, meta: { version: 3 } },
    { path: '/portraits', name: 'Portraits', component: PortraitSetupPage, meta: { version: 0 } },
    ...
    { path: '/character-crys', name: 'Crystalis', component: CharacterCrysPage, meta: { version: 2 } },
