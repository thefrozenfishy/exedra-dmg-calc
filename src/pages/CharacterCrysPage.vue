...
/* CrysDataImport renders its own "Import" heading span internally, so its
   width has to be reached with :deep() to line up with this page's other
   section labels (Char Filter / Sort / Filters / Image Share). */
:deep(.filters-heading) {
    width: 100px;
    min-width: 100px;
}
