<template>
    <div class="setup-page page">
        ...
        <div v-else class="not-found-state">
            ...
            <button class="btn" @click="goBack">Back to overview</button>
        </div>
    </div>
</template>
...
const totalCrysCount = computed(() => characterId.value ? relevantCrys(characterId.value).length : 0)
const ownedCrysCount = computed(() => {
...
function goBack() {
    router.push({ path: '/character-crys' })
}
</script>
